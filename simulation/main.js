...
window.addEventListener("DOMContentLoaded", () => {
  ...
  const retrofit = (newRound) => {

    return newRound.map( r => {
      const { roll, risk, outcome } = r.actions[0];
      ...
      const round = {
        ...
        response: {
          create: r.resources_created || 0,
          destroy: r.resources_destroyed || 0,
        },
        resources: {
          after: r.resources || 0,
        },
